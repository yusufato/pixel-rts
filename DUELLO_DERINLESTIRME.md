...
## ✅ T3 UYGULAMA DURUMU — TAMAMLANDI (tüm 6 boşluk kapandı)

| # | Boşluk | Durum | Uygulama |
|---|---|---|---|
| 10 | Baskın & pusu | ✅ | ormandaki birlik ateş edene kadar gizli (AMBUSH_DETECT=170), gizliden ilk atış ×1.45, ateş→açığa çık (revealTimer) |
| 11 | Darboğaz & su | ✅ | ızgara-harita: su geçilmez + köprü geçit + A* yol bulma (köprülerden geçer) |
| 15 | Keşif-çekişi | ✅ | KEŞİF birimi pusucuları 2× mesafeden tespit eder (önden keşif değer kazanır) |
| 17 | Cephe-genişliği/kuşatılma | ✅ | açısal kuşatma (8 sektör) → moral çöküşü (Cannae); this.encirclement |
| 18 | Tempo & OODA/C2 | ✅ | posture komut-gecikmesiyle yerleşir (C2-bağlı 1 döngü, izole 3); this.c2Linked |
| 20 | Lojistik | ✅ | ikmal hattı kesilince (arkada düşman) mühimmat durur; this.supplyCut/supplyDist |

Bu mekaniklerin ürettiği alanlar (encirclement, supplyCut/supplyDist, c2Linked, isConcealed/revealTimer, köprü/su) → Öğrenen Beyin v2 girdilerine beslenecek (OGRENEN_BEYIN_PLANI.md, 421 girdi).
