...
# ─────────────────────────────────────────────────────────────────────────────
# M2-10 — IKMAL TAKIBI (bugun bulunan kusurun duzeltmesi)
#
...
# KOK NEDEN: SUPPORT'un "ihtiyaci olanin yanina git" dali YALNIZ FIRE_WINDOW
#   fazinda kosuyor ve o faz 8-14 saniye suruyor.
# DUZELTME: BATTLE_IKMAL_TAKIP -> ayni dal tum fazlarda.
# MEKANIZMA OLCULDU: cephanesiz ornek 311 -> 14 (%25.2 -> %2.1).
#   BEDELI VAR: ikmal araci olen mac 3/6 -> 5/6, ort. olum 41sn -> 32sn.
#   Yani net kazanc MAC KAPISI olmadan soylenemez. Bu kapi onu soyler.
# ─────────────────────────────────────────────────────────────────────────────
kapi "M2-10: BATTLE_IKMAL_TAKIP false vs true @ tam guc" \
    node tools/rol-dengesi-paralel.js --tohum 128 --tohum0 229000 \
    --kol BATTLE_IKMAL_TAKIP --koldeger false,true --ayar "$TAM"
