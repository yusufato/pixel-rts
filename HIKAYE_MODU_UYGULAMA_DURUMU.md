...
| Faz 38.10 — Türetilmiş Güç ve Kariyer Yaşam Döngüsü | `partial` | `js/StoryCharacterPower.js`; salt-okunur güç görünümü kurumsal/yasal yetkiyi gerçek `authorityGrants`, ekonomik gücü şirket nakdi+tesisi, askerî gücü gerçek ARMED_FORCES makamı, ağ gücünü yönlü Faz 35 ilişkileri ve bilgi gücünü aktörün tuttuğu ActorBelief kayıtlarından türetir. Eski sabit `career.influence` okunmaz; 0/100 değiştirmek sonucu değiştirmez ve saklanan yeni güç bonusu yoktur. Makamsız unvan kurumsal güç alamaz. Medya, halk tabanı ve uzmanlık yürütücüleri yokluğu `UNAVAILABLE/null` görünür; sıfır diye gizlenmez ve uygulanamayan kanallar toplamı yapay olarak düşürmez. İkinci dilim, yeni bir yetki defteri açmadan güncel makamları ve Faz 37 `officeTransitions` kayıtlarını kariyer görünümüne bağladı. Gerçek istifa sonrası aktör `ACTIVE_OFFICE → FORMER_OFFICE_HOLDER` olur, kurumsal yetki/gücü düşer; kimlik, kişilik, hedefler, ilişkiler, önceki hafıza ve ActorBelief kanıtları silinmez. Geçiş gerçek istifa makbuzunu taşır, görünüm deterministik/salt-okunurdur. Yaş, sağlık, emeklilik ve ölüm yürütücüleri hâlâ `UNAVAILABLE`; yaşam döngüsü tamamlanmadan faz kapanmaz. |
