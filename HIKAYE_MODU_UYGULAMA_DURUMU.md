...
**Aktif çalışma zamanı:** Faz 38.1 — Oyuncu Konuşmasını Anlama
**Aktif uygulama sırası:** Faz 38.4 günlük sohbetlerini temiz 38.1 tabanı üzerinde yeniden kur; ardından Faz 38.5'i yeniden ele al
...
| Faz 38.4 — Diyalog Ağacı Senaryo Laboratuvarı | `runtime_rollback` | Senaryo laboratuvarı ve dünya/müzakere defteri çalışmaları korunuyor; fakat oyuncuya dönük yedi gündelik sosyal niyetin çalışma zamanı 12 Ağustos'ta temiz Faz 38.1 tabanına geri alındı. Günlük sohbet şu an oynanabilir değildir. Yeni kurulum eski tek-oturum sözleşmesini bozmadan yeniden yapılacaktır. |
| Faz 38.5 — Sohbet Çalışma Alanı İlk Oynanabilir Sürüm | `runtime_rollback` | Üç karakterli kriz, söz sonucu ve mekanik sözleşme defterleri korunuyor; çok turlu sohbet, LLM kuyruğu, takip bestecisi ve genişletilmiş UI çalışma zamanı iki kurtarılabilir stash'e alındı. Oyuncuda merkez oturumun sıfırlanması çözülemediği için bu sürüm aktif kabul edilmez. |
...
| Faz 38.6–38.12 — Modern Karakter Davranışı Yükseltmesi | `planned` | Dış modern davranış belgesi seçici kabul edildi. Mevcut çok-defterli mimari korunur; monolitik `CharacterV2`, ikinci güç motoru ve on korelasyonlu ilişki sayacı reddedildi. Plan; algılanan dünyaya dayalı DecisionTrace, sınırlı bias/stres/persona, olay etiketli ilişki yorumu ve geri çağrım, gerçek rol adaptörleriyle kurumsal müzakere, türetilmiş güç+kariyer, karakter tier/kohort yükselmesi ve gizlilik korumalı davranış QA/UI fazlarına ayrıldı. Aktif Faz 38.5 mini zinciri kapanmadan baştan yazım yapılmayacak; medya tüketicileri Faz 39–42 ile çapraz ilerleyebilir. |
