...
| Faz 38.13 — Oynanabilir Karakter Etkileşimi ve Resmî Toplantılar | `partial` | İlk altı dikey çalışıyor. `ConversationCaseV1` altı kip, geçiş/geçmiş/UI/göç/save-load taşır. `TaskOfferV1`; gerçek veren/üstlenen/hedef, kişisel talep, `300 sn`, ödülsüz görüşme görevi; kabul/ret/tamamlama/süre aşımı çalışır. `MeetingCaseV1`; oyuncu gündemi, kanonik makam başkanı, 3–4 erişilebilir katılımcı ve sıra kontrollü en çok 40 kamusal tur taşır. Oyuncu/karakter yalnız kendi sırasında konuşur; konuşmacı, muhatap, kaynak ve bilgi politikası kaydedilir. Katılımcı başına görünürlük matrisi kamusal tur kimliklerini eşit taşır; yalnız kendi özel bağlamına izin verir ve ham dünya okumasını yasaklar. Karakter, yalnız kendisinin tuttuğu ve kamusal/kurumsal görünürlüğe sahip `ActorBelief` içinden gündeme en yakın kaydı seçebilir; inanç ve olgu kimliği tur kaynağına bağlanır, özel kayıt otomatik açıklanmaz. UI kaynak türü ile güveni gösterir; teknik kimliği veya özel içeriği göstermez. Oyuncu toplantı katılımcısına en çok 24 ikili not gönderebilir; not kamusal transkripte girmez ve yalnız yazar/alıcı görünürlük satırına eklenir. Toplantı dışı alıcı reddedilir. Odaktaki toplantı taslağı asenkron model sonucu sırasında değerini ve seçim aralığını korur; `Ctrl+Enter` söz veya özel not gönderir. Birleşik test sıra dışı reddi, doğru rotasyonu, kaynak sahipliğini, özel-belief sızıntısı yokluğunu, ikili not yalıtımını, görev zincirini, pause/dünya nötrlüğünü, taslak korumasını ve kayıt bütünlüğünü geçti. Karakterden gelen özel not/yanıt, kanaat çıkarımı, önerge/itiraz/oy/sonuç, kurumsal görev ve yönlü ilişki fişleri açıktır. |
