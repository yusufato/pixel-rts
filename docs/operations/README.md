# Kurulum ve Operasyon Belgeleri

Bu alan oyunu yerelde çalıştırmak, paketlemek ve doğrulama tezgâhlarını işletmek için gereken kalıcı notları toplar. Belgede geçen komutlar kendiliğinden yürütme yetkisi değildir; depo scriptleri ve `package.json` ile doğrulanmalıdır.
...
- Electron paketleme ve model yerleşimi;
