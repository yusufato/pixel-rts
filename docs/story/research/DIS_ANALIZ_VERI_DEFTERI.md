...
| 12.08.2026 | Faz 38.10 ilk dilim türetilmiş güç görünümünü kurdu. Makam/yasal yetki, şirket varlığı, askerî makam, yönlü ilişki ağı ve aktörün tuttuğu bilgi gerçek defterlerden sorgulanıyor; `career.influence` kaynak değil. Makamsız unvan kurumsal güç almıyor. Medya/halk/uzmanlık boşluğu `UNAVAILABLE/null` olarak açık. Güç, rol ve ilişki probları sırasıyla yaklaşık `0,8 / 1,0 / 0,8 sn` temizdir. Kariyer geçişi ve yaşam/ölüm zinciri açık sıradır. |
...
### 12 Ağustos 2026 — ikinci gerçek sohbet borç kapatma döngüsü

- Dört karakterle yapılan yeni gerçek EXE koşusu kimlik ve rol zemininin de LLM'e bırakıldığını kanıtladı. Devlet başkanı kendini şirket yürütmesinde gösterdi, Ankara'da yaşadığını ve oyuncuyla ortak proje geçmişi bulunduğunu uydurdu; muhalefet lideri “bencil” sıfatını gerçek kabul etti; şirket yöneticisi `1000 dinarım` beyanını iki kez duymadı; ajan hitap sorusunu hakaret saydı.
- `UNKNOWN` ve kanıt-temelli güvenli cevaplar artık LLM kuyruğuna girmez. Kimlik, rol/rol çelişkisi, kuruluş bağı, oyuncuyu ne kadar tanıdığı, muhatap konumu, öznel kişi yargısı, hitap görgüsü, sürekli soru itirazı, hakaret/sınır ve bozuk fallback'e itiraz deterministik söylem odağına bağlandı.
- “Önceki sözünün devamı” genel fallback'i artık bilinmeyen amacı sahte süreklilikle açıklamaz; açıkça anlamadığını ve uydurmayacağını söyler. Servis-botu kapısı `ne tür yardım arıyorsunuz`, `konuyu belirt`, `daha fazla bilgi ver` gibi yeni gerçek model çıktılarıyla genişledi.
- Şirket/fabrika açma niyeti kelime aralığı ve Türkçe biçimleriyle tanınır. Yer ve elektronik kaynak bağlamı teklif niyetinde korunur. `1000 dinarım/dinarım var` bütçe beyanı `PLAYER_REPORTED_BUDGET / UNVERIFIED_PLAYER_REPORT` olur; gerçek bakiye değildir, fakat görüşmede kaybolmaz.
- İkinci gerçek koşudaki kimlik, rol, şirket, ilişki, yargı, sorgulama üslubu, fallback, fabrika, bütçe ve hakaret dizileri zorunlu regresyon kapısına dönüştürüldü. Hedefli sohbet, Faz 38.5 çalışma alanı ve 50 turluk uzun diyalog probları geçti.

### 12 Ağustos 2026 — sanal sohbet laboratuvarı ve üçüncü gerçek koşu

- Üçüncü gerçek EXE kaydı güvenlik kapısının halüsinasyonu azalttığını fakat sıradan konuşmayı aşırı sık `CLARIFY_UNKNOWN_WITHOUT_FAKE_CONTINUITY` duvarına düşürdüğünü gösterdi. “İşiniz nedir”, “benden çekindiğini hissediyorum”, “ne işler yapıyorsun”, “bana iş verebilir misiniz”, “enerji sıkıntısı duydum”, “anlamadım”, “peki” ve “bana cevap ver” ayrı söylem eylemlerine bağlandı.
- Karakterin önceki model cevabında uydurduğu “mevcut görevler” yeni turda gerçek kabul edilmez. Somut atama kaydı yoksa karakter önceki izlenimi geri çeker; oyuncuya iş veya görev uydurmaz. Enerji sıkıntısı ve ilişki algısı oyuncu bildirimi/yorumu olarak nitelenir.
- `probeVirtualConversationLab` gerçek oyuncu günlüğünden türetilen 12 senaryoyu soru işareti, resmî hitap, samimi hitap, büyük harf, ASCII Türkçe, fazla boşluk ve yumuşatma varyantlarıyla beş rol üzerinde iki deterministik koşuda sınar. Toplam `1.200` tur; söylem eşleşmesi, bilinmeyen-duvar oranı, servis-botu dili, LLM'siz olgusal sınır, sıfır dünya mutasyonu ve birebir tekrar üretilebilirlik zorunlu kapıdır.
- Laboratuvar ilk koşuda gerçek bir kök hata buldu: Türkçe metin normalizasyonu `İ/ı` dönüşümünü küçük harfe çevirmeden önce yaptığı için tamamen büyük yazılan doğal cümleler kayboluyordu. Sıra düzeltildi. Son koşu `1.200/1.200`, beş rol, sıfır başarısız örnek verdi; mevcut konuşma anlama ve 50 turluk uzun diyalog probları da geçti.
- Bu laboratuvar 8B doğallığını kanıtlamaz; deterministik anlam ve güvenlik katmanını ölçer. İkinci sanal katman gerçek yerel modeli GPU'da çalıştırıp kişilik, tekrar, Türkçe akıcılık ve bağlam sürdürmeyi puanlamalı; sonuçlar yine gerçek oyuncu JSONL kayıtlarıyla karşılaştırılmalıdır. Şablonların kendi şablonlarını test etmesi kabul kanıtı değildir.

### 12 Ağustos 2026 — konuşma veri temeli ve DialogueMove kararı

- Gerçek sohbet günlüğünden üretilen ilk sürümlü corpus `49` vaka/`9` aile içeriyor. `18` unknown-duvar ve `4` servis-botu örneğinin görünür kalması önemli: veri temizliği başarısız motor davranışını istatistikten silemez.
- Canlı motor artık LLM'e yalnız geçmiş + güvenli fallback vermiyor; önce `DialogueMoveV1` üretip hangi iddia/hafıza/varlığın kullanılabileceğini ve hangi taahhütlerin yasak olduğunu belirliyor.
- Eski bütün iddiaları her yeni tura geçirmek bağlam değil yetki sızıntısıdır. Bu nedenle claim seçimi cevap konusuna daraltıldı.
- 8B doğal dil zarfında aynı `moveId`yi ve kullandığı kaynakları bildirmek zorunda. Bu tek başına doğruluk kanıtı değildir, fakat sonradan “hangi kararı hangi kaynakla bozdu?” sorusunu ölçülebilir yapar.
- Geçmiş 49-vakalık corpus taraması `1` sert yargı→gerçek halüsinasyonu, `18` unknown-duvar ve `4` servis-botu buldu. Bunlar yeni motorun sonucu gibi de, düzelmiş gibi de gösterilemez; güncel motor replay'i gerekir.
- S1 kabulü henüz verilmedi. Güncel motor corpus replay'i ve bütün karar dallarında kaynak-evreni doğrulaması açık borçtur.
- Güncel deterministik replay `49/49`, sıfır atlama, sıfır sert/kalite bulgusu verdi. Bu 8B doğallık kabulü değil; güvenli anlam çekirdeği kabulidir.
- S1 kabul edildi: 48 kapalı eylem kaynak politikası taşıyor; güncel claim ve geçmiş claim yetkisi ayrıldı; katalog dışı dal, sahte ref/zarf ve tahrif edilmiş save karşı-probları geçiyor. Bu hâlâ 8B doğallık kabulü değildir.
- S2 ilk dikeyi gerçek `DiscourseStateV1` kurdu. Sosyal ara söz ticari konuyu silmiyor; onarım önceki turn kimliğine, açık soru oyuncu cevap borcuna bağlanıyor; içerikli cevap borcu kapatıyor. 20 turluk çok-sorulu/düzeltmeli kabul hâlâ açık.
- S2 kabul edildi: 20 takip turunda çoklu soru borcu, askıya alınmış konuya dönüş ve oyuncu düzeltmesinin eski claim'i sonraki DialogueMove kaynaklarından çıkarması geçti; save/load ve 49/49 replay temiz.
- S3 kabul edildi: `DomainEvidenceBundleV1` sosyal, ekonomi, siyaset, askerî ve diplomasi alanlarını aynı karar zarfında topladı. Adaptörler metin/ham dünya/komut üretemiyor; canlı prob beş alanı doğru çözdü, sahte fakat checksum'u geçerli yetki zarfını kaynak uyuşmazlığıyla reddetti. S1–S3 birim kapıları, temiz 23 takip turlu 38.5 regresyonu ve `49/49` sıfır-bulgulu replay temiz. Bayat birleşik probun geri alınmış UI/olay beklentileri başarıya yazılmadı. Aktif sıra S4 ContextPack derleyicisidir.
- S4 ilk dikeyi eklendi: `ContextPackV1` kimlik, DialogueMove, yetki, açık soru/cevap borcu, son turlar, claim ve kaynaklı hafızayı öncelikli paketler; gizli bölüm prompt'a girmez, zorunlu bölüm sessiz kesilmez. `8192 = 6642 paket + 650 sabit istem + 900 çıktı` muhasebesi açıkça tutulur. Headless tahmin gerçek tokenizer kabulü değildir; söz/sır adaptörü, gerçek tokenizer ve uzun bağlam karşı-probu açık olduğundan S4 `partial`dır.
- S4 kabul edildi: aynı yüklü Turkish-Llama 8B/CUDA tokenizer'ı `llm-host` üzerinden oyuna açıldı. Tipik gerçek askerî prompt `724 + 220 çıktı + 128 wrapper = 1072/8192`; taşma karşı-metni `12820` token ölçüldü. Üretim öncesi sert kapı ve en fazla iki düşük-öncelikli yeniden derleme çalışıyor. Oyuncuyla ilgili holder-korumalı söz/sır pakette kaldı, başka aktör sırrı sızmadı; zorunlu alanlar korunup düşük önem geçmiş atıldı, tahrif edilmiş paket reddedildi. Temiz 23 tur/save-load ve `49/49` replay geçti. Aktif sıra S5 gerçek 8B sanal koşucudur; doğallık henüz kabul edilmedi.
- S5 ilk gerçek dikey kuruldu: koşucu gerçek `llm-host/CUDA/8192`, oyun ContextPack'i, DialogueMove, JSON grammar ve üretim doğrulayıcısını kronolojik oturumlarda kullanıyor; model-atlanan deterministik turları `NOT_REQUIRED` ayırıyor ve her turun replay karmalarını kaydediyor. 12 turda `4` model-uygun çıktıdan ilk ölçüm sahte `4/4` kabul verdi; ham inceleme kanıtsız kişisel durum, yetkisiz gelecek kararı ve servis-botu buldu. Kapılar eklendikten sonraki aynı-seed sonuç `1 kabul / 3 açık-kodlu fallback / 8 NOT_REQUIRED / 0 hata / 0 taşma`, CUDA p50/p95 `3,33/3,53 sn`. S5 `partial`; 50/20/10 kısa-orta-uzun konuşma manifesti ve tam gece bataryası açık.
- S5 tam stabilite bataryası 13 Ağustos'ta bitti: oyunla aynı Electron çalışma zamanı, gerçek `llm-host`, ContextPack, DialogueMove, JSON grammar ve doğrulayıcıyla `80 görüşme/540 tur`; `220 kabul / 52 fallback / 268 NOT_REQUIRED / 0 hata / 0 taşma`. Kesintiler atomik görüşme-sınırı ara kayıt, resume ve 90 saniyelik watchdog ile veri kaybetmeden yönetildi. CUDA hazır ikilisi `Expected cuda, got false` verdiği ve sistem tanısı NVIDIA aygıtını göremediği için güvenli Vulkan fallback'i kullanıldı; p50/p95 `25,40/44,42 sn`. Bu sonuç içerik kabulü değildir: 80 oturum yalnız 9 benzersiz metin dizisi, 71 tekrar oturum, 34 birebir kabul tekrarı ve 27 aynı-soru/aynı-cevap üretti. Ham kabulde oyuncu yankısı, güven sorusundan kaçış, başarısız “neden?” devamı ve totoloji bulundu; dört sınıf artık açık fallback nedenidir. S5 koşucu kabulü tamamlandı, aktif sıra S6 benzersiz adversarial corpus ve sert ihlal kapılarıdır.
- S6 ilk dilimi eski sahte çeşitliliği kaldırdı: manifest `80/80` benzersiz dizi, `540` tur ve canlı temas dizinindeki beş rolü taşır; bulunmayan rol sessiz fallback yapamaz. İlk 12 turluk gerçek smoke kaynak olmadan bölge bilgisi sahiplenme, doğrudan cevap isteğinden kaçma ve yeni bir güven totolojisi buldu. `UNSOURCED_KNOWLEDGE_CLAIM`, `FAILED_DIRECTNESS_REQUEST` ve genişletilmiş `TAUTOLOGICAL_REPLY` kapıları eklendi; negatif regresyon `9/9`. İlk-token chunk'ı artık rapora girer; Vulkan smoke `8,88 sn` ilk-token, `18,26 sn` toplam süre verdi. Tam benzersiz S6 bataryası henüz kabul edilmedi.
- S6 ikinci kırmızı-takım döngüsü `44` turda durduruldu; ham kabulde varsayımı ortak hafıza yapma, doğrulanmamış iddiayı onaylama, kaynak olmadan doğrulama yetkisi/güncel şehir durumu uydurma, teyit ve gizlilik isteğini cevapsız bırakma, asker bildirimini oyuncu tehdidine çevirme ve sosyal check-in'i savuşturma bulundu. Sekiz açık ret sınıfı eklendi, negatif kapı `17/17`. Runner ara kaydı artık validator kaynak parmak izine bağlı; eski kabul kararları yeni doğrulayıcıya taşınamaz. Yeni 12 tur `4 kabul / 4 fallback / 4 NOT_REQUIRED / 0 hata / 0 taşma`; ilk-token p50/p95 `11,59/13,44 sn`. Tam S6 koşusu temiz validator fingerprint ile baştan çalıştırılmalıdır.

### 14 Ağustos 2026 — konu filtreli karakter hafızası ve doğal gerçekleştirme kapısı

- ContextPack'in konu gözetmeden her oyuncu görüşmesine bütün ilgili `PROMISE/SECRET` kayıtlarını taşıdığı tespit edildi. Söz, borç, karar, çatışma, önceki konuşma, ilişki geçmişi ve gizlilik artık ayrı geri-çağrım türleri üretir; ekonomi ve genel ilişki sorusu otomatik hafıza açmaz.
