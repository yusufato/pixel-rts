...
**1.7 değişikliği:** Uygulama başlatıldı. Sabit tohumlu headless hikâye laboratuvarı, `npm test`, 900 saniyelik Faz 0 referans raporu ve 30 oyun yıllık soak kapısı eklendi. İlk ölçüm, dünyanın uzun koşuda tek devlete çöktüğünü kanıtladı; sonuçlar `../status/HIKAYE_MODU_UYGULAMA_DURUMU.md` içinde kaydedildi.
...
**23 Ağustos 2026 canlı durum düzeltmesi:** Yukarıdaki on özel NLU bağlama ölçümü rollback öncesi çalışma ağacına aitti; ilgili `StoryConversationUnderstanding` dilimi commit geçmişine girmedi ve yalnız problemli sohbet stash'inde kaldı. Doğrudan karar matrisleri hâlâ geçerli, deterministik ve dünya-nötrdür. Güncel canlı çözümleyici özel speech-act veya kanonik mekanik aday uydurmaz; geçerli, komutsuz, ham dünya defteri okumayan güvenli fallback kullanır. Özel senaryoların güncel bileşimsel semantic-frame/domain-adapter mimarisine bağlanması açık entegrasyon borcudur. Eski stash bütün olarak geri yüklenmeyecek; bu kayıt Faz 63.1'deki gerçek alt sistem adaptörü kabulünü değiştirmez.
