...
**Aktif uygulama sırası:** Gerçek yetki, bedel ve sonuç makbuzlu kurumsal/ücretli görev
...
Kapanış/yetkili teklif yönlendirmesi ile görünürlük-korumalı özel not yanıtı
tamamlandı; kurumsal görev ve yönlü ilişki fişleri kapanmadan Faz 39 aktif
değildir.
...
| Faz 38.13 — Oynanabilir Karakter Etkileşimi ve Resmî Toplantılar | `partial` | İlk on dört dikey çalışıyor. `ConversationCaseV1` altı kip; `TaskOfferV1` gerçek aktörlü ödülsüz görüşme görevi; `MeetingCaseV1` kanonik başkan, 3–4 katılımcı, en çok 40 kaynaklı kamusal tur ve özel not görünürlük matrisi taşır. `MeetingMotionV1`; başkan usul incelemesi, `OBJECTION / AMENDMENT_REQUEST / ENDORSEMENT`, sürüm zinciri ve tekil oyları korur. `InstitutionProposalIntentV1` kanonik eylem/ülke/kurum/hedef kapsamını oylanan sürüme mühürler; `MeetingClosureRecordV1` kabulü yalnız canlı Faz 38.9 yetkisiyle tek Faz 29 kurum isteğine yönlendirir. Şema-6 ikili kanal, `PLAYER_NOTE → CHARACTER_REPLY` bağını kök başına tek çocukla korur. Karakter yalnız kök notu, kendisine görünür kamusal turları ve kendi `PUBLIC / INSTITUTIONAL` ActorBelief kaydını okur; başka özel not, `PRIVATE/SECRET` inanç ve ham dünya dışarıda kalır. UI yanıtı kamusal tutanak, karar, emir veya taahhüt saymaz; kapalı toplantıda geçmiş diziyi salt-okunur tutar. Birleşik test 37 kamusal tur, 5 özel kayıt, 2 karakter yanıtı, yanlış sıra/çift yanıt sıfır farkı, şema-5→6 göçü, tahrif reddi ve açık/kapalı save-load devamlılığını geçti. Kurumsal/ücretli görev ve yönlü ilişki fişleri açıktır. |
