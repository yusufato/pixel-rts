...
| Faz 38.13 — Oynanabilir Karakter Etkileşimi ve Resmî Toplantılar | `partial` | İlk on iki dikey çalışıyor. `ConversationCaseV1` altı kip, geçiş/geçmiş/UI/göç/save-load taşır. `TaskOfferV1`; gerçek veren/üstlenen/hedef, kişisel talep, `300 sn`, ödülsüz görüşme görevi; kabul/ret/tamamlama/süre aşımı çalışır. `MeetingCaseV1`; oyuncu gündemi, kanonik makam başkanı, 3–4 erişilebilir katılımcı ve sıra kontrollü en çok 40 kamusal tur taşır. Oyuncu/karakter yalnız kendi sırasında konuşur; konuşmacı, muhatap, kaynak ve bilgi politikası kaydedilir. Katılımcı başına görünürlük matrisi kamusal tur kimliklerini eşit taşır; yalnız kendi özel bağlamına izin verir ve ham dünya okumasını yasaklar. Karakter yalnız kendi açık/kurumsal `ActorBelief` kaydını kullanır; `MeetingStanceV1` gündem, rol, kişilik, yönlü ilişki ve kaynaktan beş yönlü tutum üretir. Ham eksenler UI'a sızmaz. Oyuncunun ikili notu kamusal tutanağa girmez. `MeetingMotionV1` en çok 6 önerge, başkan usul incelemesi, karakter başına tek kaynaklı `OBJECTION / AMENDMENT_REQUEST / ENDORSEMENT`, oyuncunun değişiklik kabul/reddi ve sürüm zincirini taşır. Eski sürüm itirazı başkan eliyle `MOOT_BY_REVISION`, güncel itiraz muhalefeti koruyan `DISSENT_RECORDED` olur. Oylamayı yalnız başkan, güncel sürüm `IN_ORDER`, açık değişiklik yok ve bütün itirazlar çözülmüşken açar. Her katılımcı kendi sırasında ve sürüm başına tek kabul/ret/çekimser oy verir; karakter oyu aynı sürüm tepkisi veya kaynaklı tutumdan çıkar. Tam katılımda `MeetingOutcomeReceiptV1` sayım ve sonucu kaydeder fakat dünyayı uygulamaz. Birleşik test 33 turda iki önerge, üç tepki, iki sürüm, itiraz sevki/kararı, dört oy, `3–1` kabul makbuzu, sahte oy/sayım reddi, eski kayıt göçü, save-load ve dünya nötrlüğünü geçti. Toplantı kapanış/yetkili uygulama yönlendirmesi, karakterden özel not yanıtı, kurumsal görev ve yönlü ilişki fişleri açıktır. |
