...
| EXT-ACT-016 | Üç katmanlı kaynaklı karakter hafızası ve konuşma bölümü | Kritik | `in-progress-phase36` | 24 yakın kayıt / 12 özet tavanı, EPISODE, kalıcı mihenk taşı, 12 ORIGIN + 31 ActorBelief, gerçek Talks.js→PROMISE, iki yönlü sır gizliliği, scheduler save/load ve 57-sonuçlu tam assertion seti geçti. Siyasi kriz, gerçek sır/ihanet/borç üreticileri ve uzun soak açık. |
