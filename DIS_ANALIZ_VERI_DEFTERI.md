...
|---|---|---|---|---|
| EXT-ACT-001 | Gıda/enerji üretim–talep çöküşü ve üst-akış yatırım zinciri | Kritik | `active-phase22.1` | Faz 25 kalibrasyonundan önce fiziksel stabilizasyon kapısı |
| EXT-ACT-002 | Ekonomik AI için çok adımlı bağımlılık planlaması | Yüksek | `active-phase22.1` | Faz 22.1 reçete grafı + ülke portföyü + girdi emaneti |
