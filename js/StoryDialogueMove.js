...
const STORY_DIALOGUE_MOVE_ACT_POLICIES = Object.freeze({
    ...
    CONTINUE_REQUEST: { policyId: 'CURRENT_TURN_ONLY', claimTypes: [], memory: false },
    ...
    ASK_REASON: { policyId: 'CURRENT_TURN_ONLY', claimTypes: [], memory: false },
    CORRECT_PREVIOUS_TOPIC: { policyId: 'CURRENT_TURN_ONLY', claimTypes: [], memory: false },
