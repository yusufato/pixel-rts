...
const STORY_SCHEDULER_TASKS = Object.freeze([
    ...
    Object.freeze({ id: 'loyalty', intervalSeconds: 1, phaseOffsetSeconds: 0.25 }),
    Object.freeze({ id: 'production', intervalSeconds: 2, phaseOffsetSeconds: 0.5 }),
    Object.freeze({ id: 'economy-trade-logistics', intervalSeconds: 10, phaseOffsetSeconds: 0.5 }),
    Object.freeze({ id: 'economy-regional', intervalSeconds: 10, phaseOffsetSeconds: 0.75 }),
    Object.freeze({ id: 'commander-ai', intervalSeconds: 2, phaseOffsetSeconds: 1.0 }),
    Object.freeze({ id: 'economy-macro', intervalSeconds: 10, phaseOffsetSeconds: 1.25 }),
    Object.freeze({ id: 'economy-market-price', intervalSeconds: 10, phaseOffsetSeconds: 1.5 }),
    Object.freeze({ id: 'diplomacy', intervalSeconds: 10, phaseOffsetSeconds: 1.75 }),
    Object.freeze({ id: 'economy-company', intervalSeconds: 10, phaseOffsetSeconds: 2.0 }),
    Object.freeze({ id: 'era', intervalSeconds: 10, phaseOffsetSeconds: 2.25 }),
    Object.freeze({ id: 'economy-budget', intervalSeconds: 10, phaseOffsetSeconds: 2.5 }),
    Object.freeze({ id: 'character-actions', intervalSeconds: 10, phaseOffsetSeconds: 2.75 }),
    Object.freeze({ id: 'economy-infrastructure-work', intervalSeconds: 10, phaseOffsetSeconds: 3.0 }),
    Object.freeze({ id: 'technology', intervalSeconds: 8, phaseOffsetSeconds: 3.25 }),
    Object.freeze({ id: 'economy-hex-construction', intervalSeconds: 10, phaseOffsetSeconds: 3.5 }),
    Object.freeze({ id: 'character-activation', intervalSeconds: 15, phaseOffsetSeconds: 3.75 }),
    Object.freeze({ id: 'siege', intervalSeconds: 4, phaseOffsetSeconds: 3.75 }),
    Object.freeze({ id: 'economy-ai', intervalSeconds: 10, phaseOffsetSeconds: 4.0 }),
    Object.freeze({ id: 'negotiation-deadlines', intervalSeconds: 10, phaseOffsetSeconds: 4.25 }),
    Object.freeze({ id: 'economy-hex-construction-ai', intervalSeconds: 10, phaseOffsetSeconds: 4.5 }),
    Object.freeze({ id: 'chatter', intervalSeconds: 9, phaseOffsetSeconds: 4.75 }),
    Object.freeze({ id: 'population', intervalSeconds: 10, phaseOffsetSeconds: 5.0 }),
    Object.freeze({ id: 'talks', intervalSeconds: 14, phaseOffsetSeconds: 5.25 }),
    Object.freeze({ id: 'population-needs', intervalSeconds: 10, phaseOffsetSeconds: 5.5 }),
    Object.freeze({ id: 'human-migration', intervalSeconds: 10, phaseOffsetSeconds: 6.0 }),
    Object.freeze({ id: 'city-development', intervalSeconds: 10, phaseOffsetSeconds: 6.25 }),
    Object.freeze({ id: 'institutions', intervalSeconds: 10, phaseOffsetSeconds: 6.5 }),
    Object.freeze({ id: 'power-centers', intervalSeconds: 10, phaseOffsetSeconds: 7.0 }),
    Object.freeze({ id: 'factions', intervalSeconds: 10, phaseOffsetSeconds: 7.5 }),
    Object.freeze({ id: 'replenishment', intervalSeconds: 12, phaseOffsetSeconds: 7.75 }),
    Object.freeze({ id: 'society', intervalSeconds: 10, phaseOffsetSeconds: 8.0 }),
    Object.freeze({ id: 'city-growth', intervalSeconds: 10, phaseOffsetSeconds: 8.25 }),
    Object.freeze({ id: 'state-capacity', intervalSeconds: 10, phaseOffsetSeconds: 8.5 }),
    Object.freeze({ id: 'political-crisis', intervalSeconds: 10, phaseOffsetSeconds: 9.0 }),
    Object.freeze({ id: 'elections', intervalSeconds: 10, phaseOffsetSeconds: 9.25 }),
    Object.freeze({ id: 'integrity', intervalSeconds: 10, phaseOffsetSeconds: 9.5 }),
    Object.freeze({ id: 'character-behavior', intervalSeconds: 10, phaseOffsetSeconds: 9.75 }),
    Object.freeze({ id: 'economy', intervalSeconds: 10, phaseOffsetSeconds: 0.0 })
]);
