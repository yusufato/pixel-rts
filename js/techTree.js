...
const TECH_TREE = {
    ...
    techs: [
        ...
        { id: 'blitz',     branch: 'armor', tier: 3, cost: 230, name: 'Ağ Merkezli Harekât',   desc: 'Tank atışı +%20 (hızlı yarma)',            prereq: ['maneuver'],                        effect: { tankAtk: 1.20 } },
        ...
        { id: 'veterancy', branch: 'mob',   tier: 4, cost: 390, name: 'Gazi Programı',      desc: 'TÜM birlikler +%12 dayanıklılık',          prereq: ['infiltrate'],                      effect: { allHp: 1.12 } },
        ...
        { id: 'shrapnel',  branch: 'arty',  tier: 2, cost: 150, name: 'Misket Mühimmatı',         desc: 'Topçu piyadeye +%35 (anti-piyade)',        prereq: ['barrel'],  sibling: 'shaped',      effect: { artyVsInf: 1.35 } },
        ...
        { id: 'rocketry',  branch: 'arty',  tier: 4, cost: 395, name: 'ÇNRA Bataryaları',        desc: 'Topçu splash +%30 (alan silahı)',          prereq: ['atgun'],                           effect: { artySplash: 1.30 } },
        ...
        { id: 'gendarme',  branch: 'state', tier: 1, cost: 95,  name: 'İç Güvenlik Teşkilatı', desc: 'Sadakat erimesi −%15 (erken iç güvenlik)', prereq: [],                                effect: { loyaltyHold: 0.85 } },
        ...
        { id: 'railways',  branch: 'state', tier: 2, cost: 160, name: 'Lojistik Koridorları',    desc: '⛽petrol ve 👥insan geliri +%15',           prereq: ['tax'],                             effect: { oilIncome: 1.15, manIncome: 1.15 } },
        ...
        { id: 'propaganda',branch: 'state', tier: 4, cost: 370, name: 'İletişim Başkanlığı', desc: 'Sadakat erimesi −%50 (firar/darbe azalır)', prereq: ['wareco'],                    effect: { loyaltyHold: 0.50 } },
